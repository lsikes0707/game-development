--[[
	Bird Class
	AuthorL Lacey Gruwell
	lsikes@csumb.edu

	The Bird is what we control in the game via clicking or the
	space bar; whenever we press either, the bird will flap and
	go up a little bit, where it will then be affected by gravity.
...
function Bird:collides(pipe)
	...
	-- the player a little bit of leeway with the collision
